...
public class MyMain {
	...
	public static void test(){
		...
		for(int i=1; i<=2; i++)
		{
			...
			System.out.println("The change of the amount 36 is:");//7x5cents and 1 1cent
			resM = ex1.solve(i,m1, 36);
			System.out.println();
			
			System.out.println("The change of the amount 36 is:");//20c,10c,5c,1c
			resM = ex1.solve(i,m2, 36);
			System.out.println();
	
			System.out.println("The change of the amount 58 is:");//2x20c, 10c, 5c,3x1c
